...
class ResettingController extends ContainerAware
{
    ...
    public function requestAction()
    {
        ...
        $breadcrumbs->addItem( 'Mot de passe oublié' );
    ...
    public function sendEmailAction(Request $request)
    {
        ...
        if (null === $user) {
            ...
            $breadcrumbs = $this->container->get( 'white_october_breadcrumbs' );
            $breadcrumbs->addItem( 'Accueil', $this->container->get("router")->generate( '_homepage' ));
            $breadcrumbs->addItem( 'Email invalide pour changement de mot de passe' );
        ...
        if ($user->isPasswordRequestNonExpired($this->container->getParameter('fos_user.resetting.token_ttl'))) {
            ...
            $breadcrumbs = $this->container->get( 'white_october_breadcrumbs' );
            $breadcrumbs->addItem( 'Accueil', $this->container->get("router")->generate( '_homepage' ));
            $breadcrumbs->addItem( 'Email déjà envoyé pour changement de mot de passe' );
    ...
    public function checkEmailAction()
    {
        ...
        $breadcrumbs = $this->container->get( 'white_october_breadcrumbs' );
        $breadcrumbs->addItem( 'Accueil', $this->container->get("router")->generate( '_homepage' ));
        $breadcrumbs->addItem( 'Email envoyé pour mot de passe oublié' );
    ...
    public function resetAction(Request $request, $token)
    {
        ...
        $breadcrumbs = $this->container->get( 'white_october_breadcrumbs' );
        $breadcrumbs->addItem( 'Accueil', $this->container->get("router")->generate( '_homepage' ));
        $breadcrumbs->addItem( 'Modification de votre mot de passe' );
