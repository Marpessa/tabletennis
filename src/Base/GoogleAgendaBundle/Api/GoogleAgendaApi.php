...
namespace Base\GoogleAgendaBundle\Api;

use Base\GoogleAgendaBundle\Entity\GoogleAgendaEvent;
use Base\GoogleAgendaBundle\Api\GoogleAgendaException;
...
class GoogleAgendaApi {
    ...
    protected function setEvent(\SimpleXMLElement $oData) {
        ...
        $oDataChild = $oData->children('http://schemas.google.com/g/2005#event');
