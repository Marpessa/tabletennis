...
namespace Base\ForumBundle\Router;

use Herzult\Bundle\ForumBundle\Router\ForumUrlGenerator as HerzultForumUrlGenerator;
...
class ForumUrlGenerator extends HerzultForumUrlGenerator
{
    ...
    public function urlForTopic(Topic $topic, $absolute = false)
    {
        return $this->urlGenerator->generate('herzult_forum_topic_show', array(
            'timestamp'     => $topic->getCreatedAt()->format('U'),
