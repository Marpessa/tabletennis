...
namespace TableTennis\UsefulInformationBundle\Admin;
...
class UsefulInformationAdmin extends Admin
{
    /**
        ...
        $formMapper
            ->with('Média')
                ->add('media_id', 'sonata_media_type',
                      array('label' => 'Image', 'required' => false, 'context' => 'usefulInformation', 'provider' => 'sonata.media.provider.image'))
                      //array('link_parameters'=> array( 'context' => 'news', 'provider'=>'sonata.media.provider.image')))
            ->end()
            /*->with('Média')
                ->add('media_id', 'sonata_type_model_list',
                      array('label' => 'Image'),
                      array('link_parameters'=> array( 'context' => 'usefulInformation', 'provider'=>'sonata.media.provider.image')))
            ->end()*/
            ->with('Contenu')
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            ...
            ->add('is_published', 'boolean', array('label' => 'Publié ?', 'editable' => true, 'template' => 'TableTennisUsefulInformationBundle:Admin:published.html.twig' ))
