...
class LicenseeMatch {
     ...
     * )
     */
    private $opponent_firstname;

    /**
     * @ORM\Column(type="decimal", length=3, scale=2, nullable=true)
     */
    private $opponent_point;

    /**
     * @ORM\Column(type="integer", length=4)
     */
    private $opponent_licensee_number;

    /**
     * @ORM\Column(type="integer")
     */
    private $opponent_ranking;
     ...
     * @ORM\Column(type="decimal", length=3, scale=2, nullable=true)
     */
    private $points_evaluation;

    /**
     * @var MatchType
     *
     * @ORM\ManyToOne(targetEntity="TableTennis\MatchTypeBundle\Entity\MatchType")
     * @ORM\JoinColumn(name="match_type_id", referencedColumnName="id", onDelete="SET NULL")
     */
